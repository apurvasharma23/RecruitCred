...
export const GetStartedModal: React.FC<GetStartedModalProps> = ({
  ...
  const { signup, isUsernameAvailable } = useApp();
  ...
  // Uniqueness check for RecruitCred ID
  const isIdValidFormat = uniqueId.trim().length >= 3 && /^[a-zA-Z0-9_]+$/.test(uniqueId.trim());
  const isIdAvailable = isIdValidFormat && isUsernameAvailable(uniqueId);
  ...
  const handleNextFromStep2 = (e: React.FormEvent) => {
    ...
    if (!isIdAvailable) {
      setError('This RecruitCred ID is already taken. Please choose another.');
      return;
    }
  ...
  const handleFinalSubmit = (skipOptional: boolean = false) => {
    ...
    signup({
      name: fullName.trim(),
      username: uniqueId.trim().toLowerCase(),
      email: email.trim(),
      password,
      ...
      gradYear,
      accountType,
      role: accountType === 'student' ? `${branch.split('&')[0].trim()} Student` : 'Campus Recruiter',
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl max-h-[92vh] bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-700/80 shadow-2xl overflow-y-auto">
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              ...
              {/* Student Option (Primary/Default) */}
              <button
                type="button"
        ...
        {/* ========================================================================= */}
        {/* STEP 2: CREATE CREDENTIALS & UNIQUE ID */}
        {/* ========================================================================= */}
        {currentStep === 2 && (
          <form onSubmit={handleNextFromStep2} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Set up your unique RecruitCred login identifier and secure credentials.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Agastya Sharma"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. agastya@thapar.edu or student@gmail.com"
                  className="w-full bg-slate-950 border border-slate-700/80 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500"
                  required
                />
              </div>
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-1">
                Your public profile URL: <code className="text-indigo-300 font-mono">recruitcred.dev/u/{uniqueId || 'your_id'}</code>
              </p>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-lg shadow-indigo-600/25 transition-all flex items-center justify-center gap-2 cursor-pointer mt-4"
            >
              <span>Next: College Selection</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          </form>
        )}
        ...
        {/* ========================================================================= */}
        {/* STEP 3: COLLEGE SELECTION (TELL US WHERE YOU STUDY) */}
        {/* ========================================================================= */}
        {currentStep === 3 && (
          <form onSubmit={handleNextFromStep3} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                Select your college so RecruitCred can personalize opportunities, hackathons, placement recommendations and skill insights for you.
              </p>
            </div>
        ...
        {/* ========================================================================= */}
        {/* STEP 4: PROFILE SETUP & SKILLS SELECTION (WITH SKIP) */}
        {/* ========================================================================= */}
        {currentStep === 4 && (
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Connect external profiles and select initial skills to prepare your evidence verification pipeline.
              </p>
            </div>
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-center justify-between gap-3">
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-800 transition-colors"
              >
                Skip for now
              </button>
              ...
              <button
                ...
                className="w-full sm:w-auto px-7 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-600/25 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
